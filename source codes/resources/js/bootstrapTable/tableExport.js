...
(function ($) {
    ...
    var TYPE_NAME = {
        ...
        sql: 'SQL',
        doc: 'MS-Word',
        excelSelected: 'Export Selected Records Only',
        excelAll: 'Export All Returned Records',
    ...
    $.extend($.fn.bootstrapTable.defaults, {
        ...
        exportTypes: ['excelSelected', 'excelAll'],
        exportOptions: {}
    });
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showExport) {
            ...
            if (!$export.length) {
                $export = $([
                    '<div id="exportMenu" class="export btn-group">',
                        '<button class="btn' +
                ...
                $menu.find('li').click(function () {
                    ...
                    if (that.options.exportDataType === 'all' && that.options.pagination) {
                        ...
                        //doExport();
                        alert("Function not implemented for demo");
                        that.load(data);
                    } else {
                        //doExport();
                        alert("Function not implemented for demo");
